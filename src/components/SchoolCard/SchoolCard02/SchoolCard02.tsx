export default function SchoolCard02() {
  return (
    <div className="group desktop:max-w-[calc(43%-40px)] tablet:max-w[calc(43%-40px)] mobile:text-left desktop:gap-y-8 desktop:text-right tablet:gap-y-4 mobile:gap-y-2 tablet:mb-[120px] desktop:mb-0 relative flex w-full flex-col">
      <div className="mobile:aspect-square desktop:aspect-[486/555] tablet:aspect-[486/502] relative overflow-hidden rounded-[20px]">
        <div className="mobile:gap-y-1 absolute top-0 left-0 h-full w-full scale-100 rounded-[20px] bg-[url('/bg2.png')] bg-cover object-contain object-center transition-all duration-[400ms] group-hover:scale-125 group-hover:opacity-80 group-hover:blur-[22px]" />
