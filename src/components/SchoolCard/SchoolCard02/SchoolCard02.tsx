export default function SchoolCard02() {
  return (
    <div className="group tablet:max-w-[calc(43%-40px)] tablet:text-right relative flex w-full flex-col gap-y-8">
      <div className="mobile:aspect-square tablet:aspect-[486/555] relative overflow-hidden rounded-[20px]">
        ...
        <div className="mobile:school-card-mobile-center tablet:w-auto tablet:h-auto tablet:justify-start tablet:right-8 tablet:bottom-16 tablet:items-end absolute flex flex-col gap-y-4 text-white opacity-0 transition-opacity duration-[400ms] group-hover:opacity-100">
