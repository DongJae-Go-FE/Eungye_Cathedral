    ...
    <div className={cardContainer}>
      <div className="mobile:aspect-square desktop:aspect-[486/555] tablet:aspect-[486/502] relative overflow-hidden rounded-[20px]">
        ...
        <div className={cardContent}>
          ...
          <p className="desktop:text-[18px] tablet:text-[14px] mobile:text-[12px] mobile:text-center tablet:text-left desktop:text-right w-3/4 whitespace-pre-wrap">
            {contentInfo}
          </p>
        </div>
      </div>
      <h3 className="desktop:text-right desktop:text-2xl tablet:text-[18px] font-bold text-black transition-colors duration-[400ms] group-hover:text-blue-700">
        {title}
      </h3>
    </div>
  );
