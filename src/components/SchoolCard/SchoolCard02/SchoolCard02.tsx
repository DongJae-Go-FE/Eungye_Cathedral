export default function SchoolCard02() {
  return (
    <div className="group relative flex w-full max-w-[calc(43%-40px)] flex-col gap-y-8 text-right">
      <div className="relative aspect-[486/555] overflow-hidden rounded-[20px]">
