export default function SchoolCard01() {
  return (
    <div className="group relative mr-20 mb-[200px] flex w-full max-w-[calc(57%-40px)] flex-col gap-y-8 text-left">
      <div className="relative aspect-[630/472] overflow-hidden rounded-[20px]">
